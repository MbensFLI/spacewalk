...
def test_text_to_duration_float():
  """
  Test that text_to_duration returns expected value for durations with a
  non-zero minute component
  """
...
def test_text_to_duration_integer():
  """
  Test that text_to_duration returns expected value for durations with typical
